<x-layouts.app title="Add Sales Assistant">
...
<div class="max-w-lg">
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        <h2 class="text-base font-semibold text-gray-800 mb-5">New Sales Assistant</h2>

        <form method="POST" action="{{ route('assistants.store') }}" class="space-y-4">
            @csrf

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Full Name <span class="text-red-500">*</span></label>
                <input type="text" name="name" value="{{ old('name') }}" required
                       placeholder="e.g. S.H. Neel Rewatha"
            ...
            <div>
                ...
                <textarea name="address" rows="2" required
                          ...
                          class="erp-input w-full @error('address') border-red-400 @enderror">{{ old('address') }}</textarea>
