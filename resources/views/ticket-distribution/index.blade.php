...
<div class="mb-4 flex flex-wrap items-center justify-between gap-3 print:hidden">
    ...
    <div class="flex items-center gap-2">
        ...
        <a href="{{ route('ticket-distribution.export-excel', ['date' => $date]) }}"
           class="inline-flex items-center gap-1.5 rounded-lg border border-green-600 bg-green-600 px-4 py-2 text-sm font-medium text-white hover:bg-green-700">
            <svg class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
