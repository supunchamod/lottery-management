...
<div class="flex h-full">
    ...
    <aside class="fixed inset-y-0 left-0 z-50 flex w-64 flex-col"
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-0.5">
            ...
            @php
                ...
                $navItems = [
                    ...
                    ['route'=>'winnings.index',            'label'=>'Winnings',         'adminOnly'=>false, 'icon'=>'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
            ...
            @foreach($navItems as $item)
                ...
                <a href="{{ route($item['route']) }}"
                   class="flex items-center gap-3 rounded-md px-3 py-2.5 text-sm font-medium transition-colors
                    ...
                    {{ $item['label'] }}
                    @if($item['adminOnly'])
                        <span class="ml-auto text-xs" style="color:#334155;">Admin</span>
                    @endif
                </a>
            @endforeach
        </nav>
        ...
        <div class="border-t border-slate-700 px-4 py-3">
            <div class="flex items-center gap-3 mb-2">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <p class="text-xs capitalize"
                       style="color:{{ auth()->user()->isAdmin() ? '#60a5fa' : '#94a3b8' }}">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <button type="submit" title="Sign out"
                            class="rounded-md p-1.5 text-slate-500 hover:text-red-400 hover:bg-slate-800 transition-colors">
            ...
            <p class="text-xs" style="color:#334155;">Girandurukotte &amp; Mahiyanganya</p>
        </div>
        @endauth
    </aside>
